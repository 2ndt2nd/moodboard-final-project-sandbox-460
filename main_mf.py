...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.close_tab_shortcut = QShortcut(QKeySequence(f"{MODIFIER_KEY}+W"), self)
...
class MoodboardCanvasWindow(QMainWindow):
    ...
    def __init__(self, image_paths=None):
        ...
        self.zoom_in_shortcut = QShortcut(QKeySequence(f"{MODIFIER_KEY}+="), self)
        self.zoom_in_shortcut.activated.connect(self.zoom_in)
        self.zoom_out_shortcut = QShortcut(QKeySequence(f"{MODIFIER_KEY}+-"), self)
        self.zoom_out_shortcut.activated.connect(self.zoom_out)
        self.reset_zoom_shortcut = QShortcut(QKeySequence(f"{MODIFIER_KEY}+0"), self)
        ...
        self.save_shortcut = QShortcut(QKeySequence(f"{MODIFIER_KEY}+s"), self)
